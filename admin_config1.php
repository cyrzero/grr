...
// grr_print_auto
if (isset($_POST['grr_print_auto']))
{
	if (!Settings::set("grr_print_auto", $_POST['grr_print_auto']))
	{
		echo "Erreur lors de l'enregistrement de grr_print_auto !<br />";
		die();
	}
}
...
echo "</tr>".PHP_EOL;
echo "</table>".PHP_EOL;
# Ouvrir la fenêtre d'impression au chargement de la page (0 pour non et 1 pour oui)
echo "<hr />".PHP_EOL;
echo "<h3>".get_vocab("auto_print_msg")."</h3>".PHP_EOL;
echo "<table>".PHP_EOL;
echo "<tr>".PHP_EOL;
echo "<td>".get_vocab("auto_print_msg1")."</td>".PHP_EOL;
echo "<td>".PHP_EOL;
echo "<input type='radio' name='grr_print_auto' value='1' ";
if (Settings::get("grr_print_auto") == '1')
	echo "checked=\"checked\"";
echo " />".PHP_EOL;
echo "</td>".PHP_EOL;
echo "</tr>".PHP_EOL;
echo "<tr>".PHP_EOL;
echo "<td>".get_vocab("auto_print_msg0")."</td>".PHP_EOL;
echo "<td>".PHP_EOL;
echo "<input type='radio' name='grr_print_auto' value='0' ";
if (Settings::get("grr_print_auto") == '0')
	echo "checked=\"checked\"";
echo " />";
echo "</td>".PHP_EOL;
echo "</tr>".PHP_EOL;
