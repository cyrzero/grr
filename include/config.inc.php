...
# Page d'authentification LCS
 define('LCS_PAGE_AUTHENTIF',"/../grr-test/lcs/auth.php");
# Page de la librairie ldap
 define('LCS_PAGE_LDAP_INC_PHP',"/var/www/grr-test/Annu/includes/ldap.inc.php");
# Réalise la connexion à la base d'authentification du LCS et include des fonctions de lcs/includes/functions.inc.php
 define('LCS_PAGE_AUTH_INC_PHP',"/var/www/grr-test/lcs/includes/headerauth.inc.php");
