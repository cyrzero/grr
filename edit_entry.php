...
else
{
	...
	$rep_id        	= 0;
	$rep_type      	= 0;
	$rep_end_day   	= $day; //test changement $day
	$rep_end_month 	= $month;
	$rep_end_year  	= $year;
	$rep_day       	= array(0, 0, 0, 0, 0, 0, 0);
	$rep_jour      	= 0;
...
echo '<tr><td class="CL">'.PHP_EOL;
echo '<div class="form-group">'.PHP_EOL;
//construit le sélecteur date de début
...
else
{
	...
	echo '<tr><td class="CL" >'.PHP_EOL;
	echo '<div class="form-group">'.PHP_EOL;
	//construit le sélecteur date de fin
...
if (($edit_type == "series") || (isset($flag_periodicite)))
{
	...
	echo "<tr><td class=\"CL\">";
	//construit le sélecteur date de fin de périodicité
